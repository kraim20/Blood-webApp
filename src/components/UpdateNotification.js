            ...
            <div class="container items-center px-3 py-12 lg:px-20">
                <form class="flex flex-col w-full p-10 px-8 pt-6 mx-auto my-6 mb-4 transition duration-500 ease-in-out transform bg-white border rounded-lg lg:w-1/2 ">
                    ...
                    <div class="flex items-center w-full pt-4 mb-4">
                        <button onClick={sendDataToAPI} class="w-full py-3 text-base text-white transition duration-500 ease-in-out transform bg-pink-600 border-pink-600 rounded-md focus:shadow-outline focus:outline-none focus:ring-2 ring-offset-current ring-offset-2 hover:bg-pink-800 "> Update </button>
                    </div>
                </form>
            </div>
        </>
